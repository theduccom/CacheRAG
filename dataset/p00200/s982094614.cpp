...
int main(){
    ...
    while(1){
      ...
      for(int k=0;k<m;k++){
        for(int i=0;i<m;i++){
          for(int j=0;j<m;j++){
            if(table[j][i].cost > table[j][k].cost + table[k][i].cost){
              table[j][i].cost = table[j][k].cost + table[k][i].cost;
            }
          }
        }
      }
      ...
      for(int k=0;k<m;k++){
        for(int i=0;i<m;i++){
          for(int j=0;j<m;j++){
            if(table[j][i].times > table[j][k].times + table[k][i].times){
              table[j][i].times = table[j][k].times + table[k][i].times;
            }
          }
        }
      }
